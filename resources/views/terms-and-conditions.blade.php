        ...
        <div class="col-md-8 col-lg-9">
          <div id="intro" class="space-bottom-1">
            ...
            <div class="border-bottom pb-5 mb-5">
              <h1 class="text-primary"><span class="font-weight-semi-bold">{{ config('app.name', 'Laravel') }}</span> Terms &amp; conditions</h1>
            ...
            <!-- Title -->
            <div class="mb-3">
              <h2 class="h5">Welcome to {{ config('app.name', 'Laravel') }}</h2>
            </div>
            <!-- End Title -->

            <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("{{ config('app.name', 'Laravel') }}"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
          ...
          <div id="services" class="space-bottom-1">
            ...
            <ul class="text-secondary">
              <li class="pb-2">When you register for a {{ config('app.name', 'Laravel') }} account we collect your full name, email address, and account log-in credentials.</li>
              ...
              <li class="pb-2">When you use the "Remember Me" feature of {{ config('app.name', 'Laravel') }} Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
            </ul>

            <p>When you respond to {{ config('app.name', 'Laravel') }} emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call {{ config('app.name', 'Laravel') }}. If you contact us by phone as a {{ config('app.name', 'Laravel') }} User, we may collect additional information in order to verify your identity.</p>
