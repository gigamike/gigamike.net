                  ...
                  <ul class="navbar-nav u-header__navbar-nav">
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="generalDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="generalDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Dashboard</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Profile</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">My tasks</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Projects</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Members</a></li>
                      </ul>
                    </li>
                    <!-- General -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accountSettingsDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accountSettingsDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Edit profile</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Change password</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Notifications</a></li>
                      </ul>
                    </li>
                    <!-- Account Settings -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="billingDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="billingDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Activity</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Payment methods</a></li>
                      </ul>
                    </li>
                    <!-- Billing -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accessibilityDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accessibilityDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Invite friends</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">API Token</a></li>
                      </ul>
                    </li>
                    <!-- Accessibility -->
                    ...
                    <li class="nav-item u-header__nav-item">
                      <a class="nav-link u-header__nav-link" href="#">Plans</a>
                    </li>
                    <!-- Others -->
                  </ul>
                </div>
