          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-control" id="is_active" name="is_active" required>
                <option value="Y" {{ 'Y' == old('is_active', isset($user) ? $user->is_active : '') ? 'selected' : '' }}>Yes</option>
								<option value="N" {{ 'N' == old('is_active', isset($user) ? $user->is_active : '') ? 'selected' : '' }}>No</option>
              </select>
