						...
						<table id="dataTable" class="table table-bordered table-striped table-hover table-sm" width="100%" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $user->email ?? '' }}</td>
									<td>{{ $user->name ?? '' }}</td>
									<td><a class="btn btn-sm btn-info" href="{{ route('admin.users.show', $user->id) }}">Show</a></td>
									<td><a class="btn btn-sm btn-warning" href="{{ route('admin.users.edit', $user->id) }}">Edit</a></td>
